...
(async () => {
  ...
  await fs.writeFile("retinal-screening-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("retinal-screening-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
